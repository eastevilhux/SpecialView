...
public class TestLocalImageHolderView2 extends FlexibleBannerHolder {
    ...
    public void updateUI(Object data) {
        ...
        ll_root1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (banner.getGoods().size() > 0) {

                    Toast.makeText(mItemView.getContext(), banner.getGoods().get(0).getName(), Toast.LENGTH_LONG).show();
                }
            }
        });
        ll_root2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (banner.getGoods().size() > 1) {
                    Toast.makeText(mItemView.getContext(), banner.getGoods().get(1).getName(), Toast.LENGTH_LONG).show();
                }
            }
        });
        ll_root3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (banner.getGoods().size() > 2) {
                    Toast.makeText(mItemView.getContext(), banner.getGoods().get(2).getName(), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private MyImageView image1, image2, image3;
